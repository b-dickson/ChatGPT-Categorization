...
def main(args):
    ...
    for i, pair in enumerate(pairs, start=args.start):
        ...
        claude_rating = get_rating_from_response(response, number_map)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Get rock similarity ratings using Anthropic Claude.")
    parser.add_argument(
        "--start",
        type=int,
        default=0,
    ...
    parser.add_argument(
        ...
        help="Anthropic Claude model to use (default: claude-sonnet-4-20250514)",
    )
    parser.add_argument(
        "--run_name",
        type=str,
