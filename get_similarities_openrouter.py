...
def main(args):
    ...
    for i, pair in enumerate(pairs, start=args.start):
        ...
        openrouter_rating = get_rating_from_response(response, number_map)
            ...
            writer.writerow(
                {
                    ...
                    "Human Rating": human,
                    "OpenRouter Rating": openrouter_rating,
                }
            )
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Get rock similarity ratings using OpenRouter.")
    parser.add_argument(
        "--start",
        type=int,
        default=0,
    ...
    parser.add_argument(
        ...
        help="OpenRouter model to use (default: meta-llama/llama-3.2-11b-vision-instruct:free)",
    )
    parser.add_argument(
        "--run_name",
        type=str,
